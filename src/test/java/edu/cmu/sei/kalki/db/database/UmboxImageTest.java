...
public class UmboxImageTest extends AUsesDatabase {
    ...
    public void testFindUmboxImage() {
        Assertions.assertEquals(umboxImage.toString(), UmboxImageDAO.findUmboxImage(umboxImage.getId()).toString());
    }

    @Test
    public void testFindAllUmboxImages() {
        assertEquals(1, UmboxImageDAO.findAllUmboxImages().size());
    }
    ...
    public void testInsertOrUpdateUmboxImage() {
        ...
        assertEquals(2, UmboxImageDAO.findAllUmboxImages().size());
        Assertions.assertEquals(newImage.toString(), UmboxImageDAO.findUmboxImage(newId).toString());
    }

    @Test
    public void testDeleteUmboxImage() {
        Assertions.assertEquals(umboxImage.toString(), UmboxImageDAO.findUmboxImage(umboxImage.getId()).toString());
        UmboxImageDAO.deleteUmboxImage(umboxImage.getId());
        Assertions.assertEquals(null, UmboxImageDAO.findUmboxImage(umboxImage.getId()));
    }
