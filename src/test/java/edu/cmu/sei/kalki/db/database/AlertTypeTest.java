...
public class AlertTypeTest extends AUsesDatabase {
    ...
    public void testFindAllAlertTypes() {
        int initialSize = Postgres.findAllAlertTypes().size();
    ...
    public void testInsertOrUpdateAlertType() {
        ...
        assertEquals(initialSize + 1, Postgres.findAllAlertTypes().size());
        ...
        assertEquals(initialSize + 2, Postgres.findAllAlertTypes().size());
