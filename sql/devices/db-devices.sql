...
INSERT INTO device(name, description, type_id, ip_address, status_history_size, sampling_rate, default_sampling_rate) VALUES ('PHLE 2', 'Philips Light Emulator', (SELECT id FROM device_type WHERE name='Philips Hue Light Emulator'), '10.27.151.106:800',10000, 10000, 10000);
